...
# --- Title ---
st.markdown(f"<h2 style='text-align: center;'>🔐 Verifier Login</h2>", unsafe_allow_html=True)
st.markdown("##")
...
if st.button("New user? Click here to register"):
    st.switch_page("pages/verifier/verifier_register.py")
...
if submit:
    if not email or not password:
        ...
        st.switch_page("pages/verifier/verifier.py")
